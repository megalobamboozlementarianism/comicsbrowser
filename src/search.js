...
class Search extends Component {
  ...
  handleFetch = (url) => {
    ...
    fetch("https://comixback.herokuapp.com/comics?https://comicvine.gamespot.com/api/search/?api_key=5aead445d58a27ad5910cad15ecaec148cc20127&format=json&sort=name:asc&resources=character&query=wolverine&field_list=name,deck,image")
      .then(res => res.json())
